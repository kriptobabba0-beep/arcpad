...
describe('the dictionary is complete against the ABI', () => {
  ...
  it('every error in ARCPAD_ERROR_ABI is classified', () => {
    ...
    // 66 -> 71: the five buyback errors. Each one had to be classified by
    // hand in `UNREACHABLE_BY_CONSTRUCTION` before this line could move.
    expect(ARCPAD_ERROR_ABI.length).toBe(90) // anti-vacuity
