...
const EXPECTED_INVENTORY = [
  ...
  'public:r:sync_state.head_observed_at',
...
describe('adlandirma kapisi', () => {
  ...
  it('her numeric TAM OLARAK numeric(78,0) ve _wei/_tok ile biter', async () => {
    ...
    // 47 -> 43: `limit_orders`in DORT miktar sutunu, tabloyla birlikte gitti
    // (migration 015). Sayinin GERI DUSMESI bu kapinin dogru calistiginin
